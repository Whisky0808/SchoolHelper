...
Component({
  ...
  data: {
    imgurl: [
      {
        common: "../../static/icon/orderfood.png",
        hovor: "../../static/icon/orderfood_hovor.png"
      },
      {
  ...
  methods: {
    ...
    to2(){
      ...
      wx.redirectTo({
        url: '/pages/Canteen/competition/competition'
      })
    },
    to3(){
      let that = this;
    ...
    to4(){
      ...
      wx.redirectTo({
        url: '/pages/Canteen/details/details'
      })
    },
  }
})
